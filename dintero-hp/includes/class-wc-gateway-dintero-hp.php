...
class WC_Gateway_Dintero_HP extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->auto_capture          = 'yes' === $this->get_option( 'auto_capture' );
    ...
    public function get_icon() {
        ...
        $icon_html = '<a href="https://dintero.com/" target="_blank"><img src="' . esc_attr( $icon ) . '" alt="Dintero Logo" /></a>';
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'description'                   => array(
                ...
                'default'     => __( 'Pay using Dintero Checkout solution.' ),
                'desc_tip'    => true,
            ),
            'account_id'                    => array(
                'title'       => __( 'Account ID' ),
            ...
            'auto_capture'                  => array(
                ...
                'label'       => __( 'Enable Auto Payment Capture' ),
                'type'        => 'checkbox',
                'description' => __( 'Disabling this will require that you set order status manually to processing or complete to capture the payment.' ),
                'default'     => 'yes',
                'desc_tip'    => true
            ),
            ...
            if ( $transaction_order_id === $order_id AND
                ...
                if ( array_key_exists( 'status', $response_array ) ) {
                    ...
                    if ( $response_array['status'] === 'REFUNDED' ) {
                        ...
                        wc_increase_stock_levels( $order_id );
                    } else if ( $response_array['status'] === 'PARTIALLY_REFUNDED' ) {
