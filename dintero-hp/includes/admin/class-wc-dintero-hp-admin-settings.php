...
if ( ! class_exists( 'WC_Dintero_HP_Admin_Settings', false ) ) :

	/**
	 * WC_Admin_Settings Class.
	 */
	class WC_Dintero_HP_Admin_Settings {
		...
		public static function get_settings_pages() {
			if ( empty( self::$settings ) ) {
				...
				include_once dirname( __FILE__ ) . '/settings/class-wc-dintero-hp-settings-page.php';

				$settings[] = include 'settings/class-wc-dintero-hp-settings-checkout.php';
		...
		public static function save() {
			...
			check_admin_referer( 'woocommerce-dintero-hp-settings' );
