...
if ( class_exists( 'WC_Dintero_CH_Settings_Checkout', false ) ) {
	return new WC_Dintero_CH_Settings_Checkout();
}

/**
 * WC_Admin_Settings_General.
 */
class WC_Dintero_CH_Settings_Checkout extends WC_Dintero_CH_Settings_Page {
