...
if ( ! class_exists( 'WC_Dintero_CH_Settings_Page', false ) ) :

	/**
	 * WC_Dintero_CH_Settings_Page.
	 */
	abstract class WC_Dintero_CH_Settings_Page {
		...
		private function add_scripts() {
			...
			wp_register_style( 'jquery-tiptip-css', WCDCH()->plugin_url() . '/assets/css/tipTip.css', array(), WC_VERSION );
			wp_enqueue_style( 'jquery-tiptip-css' );

			wp_register_script( 'jquery-tiptip', WCDCH()->plugin_url() . '/assets/js/admin/jquery.tipTip' . $suffix . '.js', array(), WC_VERSION, true );

			wp_register_script( 'WCDCH-setting', WCDCH()->plugin_url() . '/assets/js/admin/WCDCH-setting.js', array(), WC_VERSION );

			wp_enqueue_script( 'jquery-tiptip' );
			wp_enqueue_script( 'WCDCH-setting' );
		}
		...
		public function output() {
			...
			WC_Dintero_CH_Admin_Settings::output_fields( $settings );
		}
		...
		public function save() {
			...
			$settings = $this->get_settings();
			WC_Dintero_CH_Admin_Settings::save_fields( $settings );
